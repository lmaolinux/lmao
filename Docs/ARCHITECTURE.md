...
> * Letting any disk mount will more likely to result in users shooting on their leg, thus a time based whitelisting needed for newly mounted disks on first run that can be also unwhitelisted.
